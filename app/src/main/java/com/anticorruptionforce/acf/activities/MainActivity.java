...
import com.anticorruptionforce.acf.databinding.ActivityMainBinding;
...
import com.anticorruptionforce.acf.bottom_nav.BottomNavigationViewNew;
import com.anticorruptionforce.acf.fragments.CorruptionFragment;
import com.anticorruptionforce.acf.fragments.FindnFixFragment;
import com.anticorruptionforce.acf.fragments.HomeFragment;
import com.anticorruptionforce.acf.fragments.MoreGridFragment;
import com.anticorruptionforce.acf.fragments.MyPetitionListFragment;
import com.anticorruptionforce.acf.fragments.SocialEvilFragment;
import com.anticorruptionforce.acf.network.APIRetrofitClient;
import com.anticorruptionforce.acf.utilities.App;
import com.anticorruptionforce.acf.utilities.LocationHandler;
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null && !result.equalsIgnoreCase("")) {
                try {
                    ...
                    e.printStackTrace();
                    //FirebaseCrashlytics.getInstance().setCustomKey("MainActivity", e.getMessage());
                }
            }
        }
    }
            ...
            for(Fragment fragment : fragments){
                if(fragment != null && fragment.isVisible())
                    ...
                    if (fragment instanceof  HomeFragment){
                        loadHomeFragment();
                    }else if(fragment instanceof CorruptionFragment){
                        loadCorruptionFragment();
                    }else if(fragment instanceof FindnFixFragment){
                        loadFinnFixFragment();
                    }else if (fragment instanceof MyPetitionListFragment)
                    {
                        loadMyPetitionsFragment();
                    }
