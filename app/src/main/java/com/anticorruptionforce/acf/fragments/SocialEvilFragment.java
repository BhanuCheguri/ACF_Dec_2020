...
import com.anticorruptionforce.acf.databinding.FragmentSocialevilBinding;
...
public class SocialEvilFragment extends BaseFragment{
    ...
    private void  init() {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Social Evil");
        ...
        dataBiding.lvSocialEvilFeed.addOnScrollListener(new RecyclerView.OnScrollListener() {
    ...
    private void populateListView(ArrayList<WallPostsModel.Result> wallPostData) {
        ...
        dataBiding.lvSocialEvilFeed.setLayoutManager(new LinearLayoutManager(context));
        dataBiding.lvSocialEvilFeed.setItemAnimator(new DefaultItemAnimator());
        dataBiding.lvSocialEvilFeed.setNestedScrollingEnabled(false);
    ...
    public void signOut()
    {
        ...
        {
            e.printStackTrace();
            //FirebaseCrashlytics.getInstance().setCustomKey("SocialEvilFragment", e.getMessage());
        }
    }
}