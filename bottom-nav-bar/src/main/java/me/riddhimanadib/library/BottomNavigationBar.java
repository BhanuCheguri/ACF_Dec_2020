...
public class BottomNavigationBar implements View.OnClickListener {
    ...
    public static final int MENU_BAR_6 = 5;
    ...
    private LinearLayout mLLBar1, mLLBar2, mLLBar3, mLLBar4,mLLBar5, mLLBar6;
    private View mViewBar1, mViewBar2, mViewBar3, mViewBar4,mViewBar5, mViewBar6;
    private AppCompatImageView mImageViewBar1, mImageViewBar2, mImageViewBar3, mImageViewBar4,mImageViewBar5, mImageViewBar6;
    private AppCompatTextView mTextViewBar1, mTextViewBar2, mTextViewBar3, mTextViewBar4,mTextViewBar5, mTextViewBar6;
    ...
    public BottomNavigationBar(Context mContext, List<NavigationPage> pages, BottomNavigationMenuClickListener listener) {
        ...
        this.mLLBar6 = (LinearLayout) mActivity.findViewById(R.id.linearLayoutBar6);
        this.mLLBar3.setVisibility(View.GONE);
        ...
        this.mViewBar6 = (View) mActivity.findViewById(R.id.viewBar6);
        this.mViewBar3.setVisibility(View.GONE);
        ...
        this.mImageViewBar6 = (AppCompatImageView) mActivity.findViewById(R.id.imageViewBar6);
        this.mImageViewBar3.setVisibility(View.GONE);
        ...
        this.mTextViewBar6 = (AppCompatTextView) mActivity.findViewById(R.id.textViewBar6);
        this.mTextViewBar3.setVisibility(View.GONE);
        ...
        this.mImageViewBar4.setImageDrawable(mNavigationPageList.get(2).getIcon());
        this.mImageViewBar5.setImageDrawable(mNavigationPageList.get(3).getIcon());
        this.mImageViewBar6.setImageDrawable(mNavigationPageList.get(4).getIcon());
        ...
        this.mTextViewBar4.setText(mNavigationPageList.get(2).getTitle());
        this.mTextViewBar5.setText(mNavigationPageList.get(3).getTitle());
        this.mTextViewBar6.setText(mNavigationPageList.get(4).getTitle());
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.linearLayoutBar1) {
            ...
            return;
        }else if (view.getId() == R.id.linearLayoutBar6) {
            mListener.onClickedOnBottomNavigationMenu(MENU_BAR_6);
            return;
        } else {
            return;
        }
    ...
    private void setView(View view) {
        ...
        this.mViewBar6.setVisibility(View.INVISIBLE);
        ...
        this.mImageViewBar6.setColorFilter(ContextCompat.getColor(mContext, R.color.colorNavAccentUnselected));
        ...
        this.mTextViewBar6.setTextColor(ContextCompat.getColor(mContext, R.color.colorNavAccentUnselected));
        ...
        if (view.getId() == R.id.linearLayoutBar1) {
            ...
            this.mViewBar6.setVisibility(View.VISIBLE);
            this.mImageViewBar6.setColorFilter(ContextCompat.getColor(mContext, R.color.colorNavAccentSelected));
            this.mTextViewBar6.setTextColor(ContextCompat.getColor(mContext, R.color.colorNavAccentSelected));
            return;
        }else {
            return;
        }
